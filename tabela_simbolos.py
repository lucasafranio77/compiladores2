    ...
    # este é o caso que salva os numeros
        ...
        if proc:
            if lex[1] == "NumeroInteiro":
                tabela_simbolos.append([lex[0],"num", cat, tipo, int(lex[0]), lex[2],"local"])
                print("to salvando num inteiro local")
            elif lex[1] == "NumeroReal":
                tabela_simbolos.append([lex[0],"num", cat, tipo, float(lex[0]), lex[2],"local"])
            ...
            if lex[1] == "NumeroInteiro":
                tabela_simbolos.append([lex[0],"num", cat, tipo, int(lex[0]), lex[2],"global"])
                print("to salvando num inteiro global")
            elif lex[1] == "NumeroReal":
                tabela_simbolos.append([lex[0],"num", cat, tipo, float(lex[0]), lex[2],"global"])
